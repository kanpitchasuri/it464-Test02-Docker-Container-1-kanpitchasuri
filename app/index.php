...
$host = 'TEST02'; // แก้ไขให้ตรงกับค่าทีอยู่ใน Docker Compose หรือ .env
$user = 'kanpitchasuri'; // แก้ไขให้ตรงกับค่าที่อยู่ใน Docker Compose หรือ .env
$db   = 'DB_kanpitchasuri'; // แก้ไขให้ตรงกับค่าที่อยู่ใน Docker Compose หรือ .env
